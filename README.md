...
```bash
Name        : Harshit Kumar Pathak
Role        : Cyber Security Student
University  : Parul University
Location    : Vadodara, Gujarat, India
Focus       : Web Security, Reverse Engineering,
...
I am a Cyber Security student passionate about identifying vulnerabilities,
understanding malware behavior, and strengthening digital defenses.

I actively participate in CTF challenges, security research, and practical
...
![Burp Suite](https://img.shields.io/badge/Burp_Suite-black?style=flat-square)
![OWASP](https://img.shields.io/badge/OWASP-black?style=flat-square)
...
```bash
root@github:~# Security is not a product, but a process.
```
